...
%Image::ExifTool::Sony::Main = (
    ...
    0x1003 => { #9 (64 bytes, contains Panorama info for various DSC, NEX, SLT and DSLR models)
        ...
        Condition => '$$valPt =~ /^(\0\0)?\x01\x01/', # (little- or big-endian int32u = 257)
...
%Image::ExifTool::Sony::Tag9402 = (
    ...
    0x17 => {
        ...
        PrintConv => {
            0 => 'Multi',
            1 => 'Center',
            # 2 - seen for DSC-WX300,WX60
            3 => 'Flexible Spot',
            # 10 - seen for DSC-WX100,WX300,WX60
            14 => 'Tracking',
            15 => 'Face Tracking',
            255 => 'Manual',
        },
...
%Image::ExifTool::Sony::AFInfo = (
    ...
    # In each block, the 9th, 10th and 11th byte appear to relate to AFPoint as at offsets 0x07, 0x08, 0x09.
