...
%Image::ExifTool::Sony::Main = (
    ...
    0x2010 => [ #12
        ...
        # unknown offsets or values for DSC-TX20/TX55, DSC-RX100M2, DSC-QX10/QX100, DSC-RX10, ILCE-7/7R/5000
    {
        Name => 'Tag2010a', # ad
        ...
        Name => 'Tag2010g', # ?
        Condition => '$$self{Model} =~ /^(DSC-RX10|ILCE-7|ILCE-7R|ILCE-5000)\b/',
...
#
    ...
    # 0x23 (e) for DSC-RX10, ILCE-7/7R, ILCE-5000
    ...
    0x9401 => {
        ...
        #   43 00 66 0e    0x0a1b    (n)  ILCE-7/7R, DSC-RX10, ILCE-5000
        #
    ...
    0x9402 => [{
        ...
        #   0x12,0x13 0x01     DSC-RX10, ILCE-7/7R, ILCE-5000
    ...
    # DSC-RX10, ILCE-7/7R, ILCE-5000    136 var  (0x3a = 58 var enc.)
    0x9405 => [{
        Name => 'Tag9405a',
...
%Image::ExifTool::Sony::Tag2010g = ( #12
    ...
    CHECK_PROC => \&Image::ExifTool::CheckBinaryData,
    FORMAT => 'int8u',
    NOTES => 'Valid for DSC-RX10, ILCE-7/7R/5000.',
    WRITABLE => 1,
    FIRST_ENTRY => 0,
    PRIORITY => 0,
    GROUPS => { 0 => 'MakerNotes', 2 => 'Image' },
...
#           difference between 0x0002 and 0x0004 mostly 0.0, 0.1 or 0.2 stops.
    ...
    0x004c => { # only ILCE-7/7R/5000
        Name => 'ImageCount2',
        Condition => '$$self{Model} =~ /^(ILCE-7|ILCE-7R|ILCE-5000)\b/',
        Format => 'int32u',
        RawConv => '$val & 0x00ffffff',
    },
    0x0051 => { # only ILCE-7/7R/5000, but hours usually different from SonyDateTime - UTC?
        Name => 'SonyDateTime2',
        Condition => '$$self{Model} =~ /^(ILCE-7|ILCE-7R|ILCE-5000)\b/',
        Groups => { 2 => 'Time' },
        Shift => 'Time',
...
%Image::ExifTool::Sony::Tag9405b = (
    ...
    DATAMEMBER => [ 0x005e ],
    GROUPS => { 0 => 'MakerNotes', 2 => 'Image' },
    NOTES => 'Valid for the DSC-RX10 and ILCE-7/7R/5000.',
...
#            2 for A58/99V, NEX-3N/5R/5T/6/VG30/VG900, ILCE-3000/7/7R/5000
