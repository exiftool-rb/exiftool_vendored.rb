...
my %sonyLensTypes2 = (
    ...
    44 => 'Metabones Canon EF Smart Adapter', # (NC) ILCE-7R with Zeiss Otus 55mm F1.4 ZE via Metabones Smart Adapter
...
#    32xxx => 'Sony E PZ 18-105mm F4 G OSS',
...
%Image::ExifTool::Sony::Main = (
    ...
    # 0x200d - rational64u: 10/10, seen 2.5 for DSC-TX300V, 8 for DSC-HX100V
    0x200e => { #PH (HX20V)
        Name => 'PictureEffect',
        Writable => 'int16u',
        PrintConv => {
    ...
    0x2010 => [ #12
        ...
        # unknown offsets or values for DSC-TX20/TX55, DSC-RX100M2, DSC-QX10/QX100
    {
        Name => 'Tag2010a', # ad
        ...
        Condition => q{
            $$self{Model} =~ /^(SLT-A99V?|SLT-A58|ILCE-3000|NEX-(3N|5R|5T|6|VG900|VG30E)|DSC-(RX100|RX1|RX1R))$/ or
        ...
        Name => 'Tag2010g', # ?
        Condition => '$$self{Model} =~ /^(DSC-RX10|ILCE-7|ILCE-7R)\b/',
...
#
    ...
    0x9401 => {
        ...
        #   43 00 66 0e    0x0a1b    (n)  ILCE-7/7R, DSC-RX10
        #
    ...
    0x9402 => [{
        ...
        #   0x12,0x13 0x01     DSC-RX10, ILCE-7/7R
        #   var       var      SLT-A58/A99V
        # only valid when first byte 0x0f, 0x10, 0x11, 0x12, 0x13 (enciphered 0x8a, 0x70, 0xb6, 0x69, 0x88)
        Condition => '$$self{DoubleCipher} ? $$valPt =~ /^[\x7e\x46\x1d\x18\x3a]\x01/ : $$valPt =~ /^[\x8a\x70\xb6\x69\x88]\x01/',
    ...
    # SLT, DSC-RX100/RX1, NEX, ILCE-3000  3   0  (0x1b = 27 0 enc.)
    # DSC-RX1R                            4   0  (0x40 = 64 0 enc.)
    # DSC-RX100M2                         5   0  (0x7d = 125 0 enc.)
    # DSC-RX10, ILCE-7/7R               136 var  (0x3a = 58 var enc.)
    0x9405 => [{
        Name => 'Tag9405a',
...
#         2nd byte = 1: AFInfo for SLT models (also see 1 for DSC-HX20W/WX70)
...
%Image::ExifTool::Sony::Tag2010g = ( #12
    ...
    CHECK_PROC => \&Image::ExifTool::CheckBinaryData,
    FORMAT => 'int8u',
    NOTES => 'Valid for DSC-RX10, ILCE-7/7R.',
    WRITABLE => 1,
    FIRST_ENTRY => 0,
    GROUPS => { 0 => 'MakerNotes', 2 => 'Image' },
    0x0004 => { %releaseMode2, Format => 'int32u' }, # NOT at offset 0x08 !
...
#           difference between 0x0002 and 0x0004 mostly 0.0, 0.1 or 0.2 stops.
    0x0031 => { #12  not DSC-RX
        ...
        PrintConv => {
            ...
            # 66 => 'Built-in Flash present but ????',   # seen for A58 HDR and panorama image
    ...
    # 0x0104 - same as 0x0105, but has value 3 for DT 18-135mm and for 70-400mm G II: meaning ??
    0x0105 => {
        Name => 'LensMount',
        DataMember => 'LensMount',
...
#    0x0229 - int16u  LensType2  Condition => '$$self{Model} =~ /^NEX-(5R|6)/',
...
#
#    0x022c - int16u  LensType2  Condition => '$$self{Model} =~ /^(SLT-A(58|99V)|NEX-(3N|VG900|VG30E))/',
...
%Image::ExifTool::Sony::Tag9400c = ( #12
    ...
    0x0012 => { %sequenceImageNumber }, # or sequenceFileNumber ?
    0x0016 => {
        Name => 'SequenceLength',
        PrintConv => {
            0 => 'Continuous',
...
%Image::ExifTool::Sony::Tag9405a = (
    ...
    DATAMEMBER => [ 0x0604 ],
    GROUPS => { 0 => 'MakerNotes', 2 => 'Image' },
    # 0x0602 - same as 0x0604, but has value 3 for DT 18-135mm and for 70-400mm G II: meaning ??
    0x0603 => {
        Name => 'LensFormat',
        Condition => '$$self{Model} !~ /^DSC-/',
        PrintConv => {
...
#    0x0005: int8u, seen  73 - 117: maybe Fahrenheit ? (higher than "AmbientTemperature")
