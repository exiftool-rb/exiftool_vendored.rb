...
written.  This option is applied automatically when deleting all XMP and
writing new XMP back in one step.  When reading, this option causes a
warning to be issued if standard XMP is found after the IDAT chunk.
...
even if some individual tags in the group are not writable (unless a family
2 group is specified, in which case the tags are deleted individually).  Use
...
RTF, Radiance, Rawzor, Real, SVG, SigmaRaw, Stim, Theora, Torrent, Vorbis,
XML, XMP, ZIP
...
XMP-dex, XMP-digiKam, XMP-dwc, XMP-exif, XMP-expressionmedia, XMP-extensis,
XMP-fpv, XMP-ics, XMP-iptcCore, XMP-iptcExt, XMP-lr, XMP-mediapro,
