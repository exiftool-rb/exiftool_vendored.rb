...
#           difference between 0x0002 and 0x0004 mostly 0.0, 0.1 or 0.2 stops.
    ...
    0x004c => { # only ILCE-7/7R
        Name => 'ImageCount2',
        Condition => '$$self{Model} =~ /^(ILCE-7|ILCE-7R)\b/',
        Format => 'int32u',
        RawConv => '$val & 0x00ffffff',
    },
    0x0051 => { # only ILCE-7/7R, but hours usually different from SonyDateTime - UTC?
        Name => 'SonyDateTime2',
        Condition => '$$self{Model} =~ /^(ILCE-7|ILCE-7R)\b/',
        Groups => { 2 => 'Time' },
        Shift => 'Time',
...
%Image::ExifTool::Sony::Tag9405b = (
    ...
    DATAMEMBER => [ 0x005e ],
    GROUPS => { 0 => 'MakerNotes', 2 => 'Image' },
    NOTES => 'Valid for the DSC-RX10 and ILCE-7/7R.',
