...
%Image::ExifTool::Sony::Main = (
    ...
    0x2010 => [ #12
        ...
        # unknown offsets or values for DSC-TX20/TX55/RX100M2/QX10/QX100/RX10/HX60V/HX400V/WX220, ILCE-7/7R/5000/6000
    {
        Name => 'Tag2010a', # ad
        ...
        Name => 'Tag2010g', # ?
        Condition => '$$self{Model} =~ /^(DSC-(RX10|HX60V|HX400V|WX220)|ILCE-(7R?|[56]000))\b/',
...
#
    ...
    # DSC-RX10/HX400V/HX60V/WX220, ILCE-7/7R/5000/6000   136 var  (0x3a = 58 var enc.)
    0x9405 => [{
        Name => 'Tag9405a',
    ...
    0x940c => [{
        Name => 'Tag940c',
        Condition => '$$self{Model} !~ /^(SLT-|HV|DSC-|Stellar)\b/',
...
%Image::ExifTool::Sony::Tag9405b = (
    ...
    DATAMEMBER => [ 0x005e ],
    GROUPS => { 0 => 'MakerNotes', 2 => 'Image' },
    NOTES => 'Valid for the DSC-RX10/HX60V/HX400V/WX220 and ILCE-7/7R/5000/6000.',
